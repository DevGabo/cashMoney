...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        ...
        setIconImage(new ImageIcon(getClass().getResource("../Pictures/Casino-Logo.png")).getImage());
...
//        }
    ...
    public void Users() {
        ...
        XMLUsers userFile = new XMLUsers();
        List<Users> usersList = userFile.readFile("users.xml");
        if ((this.txtViewPassword.getText().equalsIgnoreCase("13579zk")
            ...
            for (Users pasword : usersList) {

                if ((this.txtUser.getText().equalsIgnoreCase("" + pasword.getUserCC())
                        && this.txtPassword.getText().equalsIgnoreCase(pasword.getPassword())
                        && pasword.getUserType() == 0)
                        || (this.txtUser.getText().equalsIgnoreCase("" + pasword.getUserCC())
                        && this.txtViewPassword.getText().equalsIgnoreCase(pasword.getPassword())
                        && pasword.getUserType() == 0)) {
                    EmployeeIU Wconnect = new EmployeeIU();
                    Wconnect.setVisible(true);
                    dispose();

                } else if ((txtUser.getText().equalsIgnoreCase("" + pasword.getUserCC())
                        && this.txtPassword.getText().equalsIgnoreCase(pasword.getPassword())
                        && pasword.getUserType() == 1)
                        || (txtUser.getText().equalsIgnoreCase("" + pasword.getUserCC())
                        && this.txtViewPassword.getText().equalsIgnoreCase(pasword.getPassword())
                        && pasword.getUserType() == 1)) {
                    MenuManager Wconnect = new MenuManager();
                    Wconnect.setVisible(true);
