...
public class EmployeeIU extends javax.swing.JFrame {
    ...
    private List<DataDayReport> DataDayReportList;
    private int indexDatadayReport;
    final String filename = "datadayreport.xml";
    
    

    public List<DataDayReport> getDataDayReportList() {
        return DataDayReportList;
    }

    public void setDataDayReportList(List<DataDayReport> DataDayReportList) {
        this.DataDayReportList = DataDayReportList;
    }

    public int getIndexDatadayReport() {
        return indexDatadayReport;
    }

    public void setIndexDatadayReport(int indexDatadayReport) {
        this.indexDatadayReport = indexDatadayReport;
    }
    ...
    public EmployeeIU() {
        ...
        this.setDataDayReportList(dataFile.readFile(filename));
        this.setIndexDatadayReport(this.getDataDayReportList().size() > 0 ? 0 : -1);
   ...
   /**
     ...
     */  
        ...
        jcbNumberMachine.setSelectedIndex(0);
        txtInput.setText("");
        txtOut.setText("");
    ...
    private void saveInterface() {
        if (jcbNumberMachine.getSelectedItem().equals(" ")
            ...
            this.getDataDayReportList().add(dateReport);
            this.setIndexDatadayReport(this.getIndexDatadayReport() + 1);
            XMLReportDay dataFile = new XMLReportDay();
            dataFile.writeDataDayReport(this.getDataDayReportList(), this.filename);
            butNew.setText("New");
